    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                ...
                <header id="header">
                    <a href="{$app_url}" class="logo"><strong>{$page_header|default:"Kalkulator kredytowy"}</strong></a>
                </header>
            ...
            <div class="inner">
                ...
                <nav id="menu">
                    ...
                    <ul>
                        ...
                        <li><a href="{$app_url}/app/calc.php">Kalkulator kredytowy</a></li>
                        <li><a href="{$app_url}/app/about.php">O projekcie</a></li>
                    </ul>
                </nav>
